...
/*
u32 TTT::mirrorH(u32 position) {
    return (position & TTT::T_MASK) >> 12 |
           (position & TTT::MH_MASK) |
           (position & TTT::B_MASK) << 12;
}
*/
...
/*
u32 TTT::rotateL(u32 position) {
    return (position & TTT::L1_MASK) >> 12 |
           (position & TTT::L2_MASK) >> 4 |
           (position & TTT::L3_MASK) >> 8 |
           (position & TTT::L4_MASK) |
           (position & TTT::L5_MASK) << 4 |
           (position & TTT::L6_MASK) << 8 |
           (position & TTT::L7_MASK) << 12;
}
*/
